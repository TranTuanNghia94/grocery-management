...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.Barcode = field.NewString(tableName, "barcode")
	...
	_product.TaxRate = field.NewFloat64(tableName, "tax_rate")
	_product.Weight = field.NewFloat64(tableName, "weight")
	_product.WeightUnit = field.NewString(tableName, "weight_unit")
	_product.IsActive = field.NewBool(tableName, "is_active")
...
func (p *product) updateTableName(table string) *product {
	...
	p.TaxRate = field.NewFloat64(table, "tax_rate")
	p.Weight = field.NewFloat64(table, "weight")
	p.WeightUnit = field.NewString(table, "weight_unit")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["tax_rate"] = p.TaxRate
	p.fieldMap["weight"] = p.Weight
	p.fieldMap["weight_unit"] = p.WeightUnit
