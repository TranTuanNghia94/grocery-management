...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.CreatedBy = field.NewString(tableName, "created_by")
	_permission.UpdatedBy = field.NewString(tableName, "updated_by")
	_permission.DeletedBy = field.NewString(tableName, "deleted_by")
