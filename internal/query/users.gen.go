...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.GroceryID = field.NewString(tableName, "grocery_id")
	...
	_user.UpdatedBy = field.NewString(tableName, "updated_by")
	_user.DeletedBy = field.NewString(tableName, "deleted_by")
...
func (u *user) updateTableName(table string) *user {
	...
	u.GroceryID = field.NewString(table, "grocery_id")
